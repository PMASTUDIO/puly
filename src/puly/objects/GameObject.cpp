...
Puly::GameObject::GameObject(Window& owner, int priority, std::string debugName, bool isProcedural, glm::vec3 m_Position, glm::vec3 velocity, glm::vec3 scale)
	: m_Owner(owner), m_Priority(priority), m_DebugName(debugName), m_IsProcedural(isProcedural), m_Position(m_Position), m_Scale(scale), m_Velocity(velocity), m_Rotation(0.0f), m_IsActive(true)
{
