...
Puly::GameObject::GameObject(Window& owner, int priority, std::string debugName, entt::entity handle, Scene2D* sceneOwner, bool isProcedural)
	: m_Owner(owner), m_Priority(priority), m_DebugName(debugName), m_IsProcedural(isProcedural), m_EntityHandle(handle), m_Scene(sceneOwner)
{
